...
Now, generate side-by-side phylomorphospace plots using the `plotGMPhyloMorphoSpace` function (the plot parameters here serve to make the text a bit more readable, at least for peripheral species):

```{r post_2017-08_phylomorphospace}
...
```{r post_2017-08_phylomorphospace_axisflip}
