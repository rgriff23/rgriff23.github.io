...
# load functions
#source('')
source('~/Dropbox/Dissertation/Dissertation chapters/Chapter 4 - Landmarks and measurement error/R/read.pp.R', chdir = TRUE)

# import landmarks into R
pp <- read.pp('~/Dropbox/Dissertation/Dissertation chapters/Chapter 5 - Adaptation in the skull/Landmarks/Cebuella_pygmaea_M_AMNH-M-76327_picked_points.pp')
pp
