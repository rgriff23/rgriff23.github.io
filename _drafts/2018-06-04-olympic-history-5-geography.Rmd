...
```{r post_2018-06_geography_host_cities}
...
```{r post_2018-06_geography_amsterdam_1928, fig.width=5, fig.height=3}
...
```
```{r post_2018-06_geography_munich_1972, fig.width=5, fig.height=3}
# Plot: Munich 1972
ggplot(world, aes(x = long, y = lat, group = group)) +
...
```
```{r post_2018-06_geography_rio_2016, fig.width=5, fig.height=3}
# Plot:  Rio 2016
ggplot(world, aes(x = long, y = lat, group = group)) +
