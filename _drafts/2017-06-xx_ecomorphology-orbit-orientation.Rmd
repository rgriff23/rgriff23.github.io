...
Now I will replicate Heesy's analysis using the data that was published with the paper, with the slight difference that I cut 35 of Heesy's original 331 taxa that lacked phylogenetic data. I did this in order to facilitate a direct comparison between the results of phylogenetic and non-phylogenetic analyses. As the R code below demonstrates, my results are highly consistent with what Heesy (2008) reported in Table 1 of his paper, despite the removal of 35 taxa:
...
If you want to follow along with the rest of my analysis, make sure to have the following R packages installed (see [info on installing `geomorph`](https://github.com/geomorphR/geomorph/wiki/Installing-geomorph): 
