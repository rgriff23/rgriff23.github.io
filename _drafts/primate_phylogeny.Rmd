...
Now we will perform ancestral state reconstructions (ASRs) and visualize the results across nodes. First, estimate the ASRs for the first continuous trait in our original data, using... 
```{r}
# estimate continuous ASRs
