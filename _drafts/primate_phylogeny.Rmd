...
```{r  post_2017-05_ggtree_asr1, fig.width=7, fig.height=7}
# basic plot
p11 <- ggtree(tree) +
  xlim(0,100) +
...
Note that setting the aesthetic `fill=..x..` and using `scale_fill_gradient` with the same low and high colors as our `gheatmap` allows us to plot minimalistic histograms that use color shading to achieve what we usually achieve with an x-axis.  
...
```{r post_2017-05_ggtree_asr2, fig.width=7, fig.height=7}
# make trait binary
