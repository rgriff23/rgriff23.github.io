...
<br>
<a target="_blank" href="https://github.com/rgriff23/btw">Go to GitHub --></a>
...
```{r, tidy=TRUE, message=FALSE, cache=TRUE}
library(devtools)
install_github("rgriff23/btw")
library(btw)
```

Before using any of the functions that call BayesTraitsV2, you have to download Version 2 of [BayesTraits](http://www.evolution.rdg.ac.uk/BayesTraits.html). You then have to tell `btw` where to find it on your computer by defining the hidden variable `.BayesTraitsPath`. You will have to define `.BayesTraitsPath` every time you start a new R session.
