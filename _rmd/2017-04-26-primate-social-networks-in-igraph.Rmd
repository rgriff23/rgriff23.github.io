...
# knitr
knitr::opts_chunk$set(fig.path = "assets/Rfigs/", message=FALSE, fig.align = 'center')
...
```{r post_2017-04_primate-sna_papio-default, fig.width=6, fig.height=6}
...
```{r post_2017-04_primate-sna_papio-pretty, fig.width=6, fig.height=6}
...
```{r post_2017-04_primate-sna_papio-layouts, fig.width=8, fig.height=8}
...
```{r post_2017-04_primate-sna_papio-pan, fig.width=8, fig.height=4}
...
```{r post_2017-04_primate-sna_centrality, fig.width=9, fig.height=4}
