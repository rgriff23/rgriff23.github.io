...
```{r post_2017-06_twitterstorm_influential_tweets}
...
```{r post_2017-06_twitterstorm_wordcloud_all}
...
tweet_data$cluster2 <- mapvalues(tweet_data$cluster, 1:12, c("Apolitical", "Rightwing","Leftwing",NA,NA,NA,NA,NA,NA,NA,NA,NA))
