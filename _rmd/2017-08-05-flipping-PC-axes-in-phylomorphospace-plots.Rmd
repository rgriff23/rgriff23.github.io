...
```{r post_2017-08_phylomorphospace, warning=FALSE, results="hide", fig.width=10}
...
```{r post_2017-08_phylomorphospace_axisflip, warning=FALSE, results="hide", fig.width=10}
